...
<div class="col-md-8 col-lg-6 vstack gap-4">
    <div class="card">
        ...
        <div class="card-body">
            <form class="row g-3" action="{{ route('usuarios.update', ['inst_codigo' => $usuario->inst_codigo, 'usvi_codigo' => $usuario->usvi_codigo]) }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" rows="3" placeholder="Descripción atractiva para mostrar en su portada. Ejemplo: Apoyando continuamente el desarrollo regional en Vinculamos SpA" id="presentacion" name="presentacion">{{ old('presentacion') ?? @$usuario->usvi_presentacion }}</textarea>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" rows="5" placeholder="Relación entre su ocupación laboral, profesión y vinculación con el medio" id="intereses" name="intereses">{{ old('intereses') ?? @$usuario->usvi_intereses }}</textarea>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" rows="5" placeholder="Habilidades personales y/o profesionales" id="habilidades" name="habilidades">{{ old('habilidades') ?? @$usuario->usvi_habilidades }}</textarea>
