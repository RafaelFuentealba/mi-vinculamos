    ...
    // END: Video player
		...
		darkMode: function () {
			...
			var changeThemeToDark = () => {
				...
				if(dir == 'rtl') {
						style.setAttribute('href', window.location.origin+'/public/css/style-dark-rtl.css');
				} else {
						style.setAttribute('href', window.location.origin+'/public/css/style-dark.css');
				}
			...
			var changeThemeToLight = () => {
				...
				if(dir == 'rtl') {
						style.setAttribute('href', window.location.origin+'/public/css/style-rtl.css');
				} else {
						style.setAttribute('href', window.location.origin+'/public/css/style.css');
				}
